...
Locales["pt_lang"] = {
    ...
    brushPrompt = "Escovar",
    feedPrompt = "Alimentar",
    waterPrompt = "Água",
    grazePrompt = "Pastar",
    needBrushItem = "Precisas de uma escova de cavalo",
    needFeedItem = "Precisas de comida para o cavalo",
    dismountToCare = "Desce do cavalo primeiro",
